...
#Windows:
attackFolder = "C:/Users/will/Documents/school/Kettering/VeremiData/" #Folder where all of the logs are
fileName = "temp" #Extracting attack type
outputFolder = "C:/Users/will/Documents/school/Kettering/NCPVeReMi/Data/VeReMi/" #Where csvs will go
...
outputFolder = "/Users/will/LocalDocuments/Kettering/NCPVeReMi/Data/VeReMi/" #Where csvs will go
'''
...
for subfolder in os.listdir(attackFolder):
    ...
    vehicles[foldName] = {}
    for log in os.listdir(attackFolder+subfolder+"/veins-maat/simulations/securecomm2018/results/"):
...
for subfolder in os.listdir(attackFolder):
    ...
    for log in os.listdir(attackFolder+subfolder+"/veins-maat/simulations/securecomm2018/results/"):
        ...
        if log.endswith('.json') and not log.startswith("Gr") and not log.startswith('._'): #Get all files without ground truth
            ...
            countsSinceLocal = {}
            prevTelems = {}
            data = pd.read_json(attackFolder+subfolder+"/veins-maat/simulations/securecomm2018/results/"+log, lines=True) #Get all of the entries
    ...
    dataset.to_csv(open(outputFolder+fileName+str(iter)+".csv", 'w')) #Output to CSV'
    print(fileName+str(iter) + " Done")
